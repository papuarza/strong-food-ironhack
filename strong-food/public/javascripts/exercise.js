var x = ["ab crunch machine, abdominals",
...
function createRutines(y) {
    var series = [3,4,5];
    var reps = [6,8,10,12,14];
    var img = ["http://wallpaper-gallery.net/images/hd-fitness-wallpapers/hd-fitness-wallpapers-15.jpg",
    "https://kite.sista.zone/wp-content/uploads/sites/3/2016/04/largehiit.jpg",
    "http://cdn-mf0.heartyhosting.com/sites/mensfitness.com/files/30-minute-hiit-main.jpg",
    "http://www.bodybuilding.com/images/2016/june/10-best-muscle-building-leg-exercises-v2-5-640xh.jpg",
    "http://cdn.skinnyms.com/wp-content/uploads/2015/05/HIIT-Kettlebell-Fat-Blaster-1.jpg",
    "http://movetica.de/templates/Movetica/themes/bootstrap/img/wow/images/skins.jpg",
    "http://razestrength.com/media/1158/img_6162_800.jpg",
    "https://secure.static.tumblr.com/2012f3ccbb8f9fba0e45a5a2b9601bb5/bk5swtd/Lhuo70154/tumblr_static_tumblr_static_3pk45cgln4ys44w888cco8sk0_640.jpg",
    "https://static.pexels.com/photos/136410/pexels-photo-136410.jpeg",
    "https://static.pexels.com/photos/17840/pexels-photo.jpg",
    "https://static.pexels.com/photos/136404/pexels-photo-136404.jpeg",
    "https://static.pexels.com/photos/116079/pexels-photo-116079.jpeg",
    "https://static.pexels.com/photos/136409/pexels-photo-136409.jpeg",
    "https://static.pexels.com/photos/116078/pexels-photo-116078.jpeg",
    "https://static.pexels.com/photos/116077/pexels-photo-116077.jpeg"];
    def = y.map(function(elem){
      let serie = series[Math.floor(Math.random()*series.length)];
      let repet = reps[Math.floor(Math.random()*reps.length)];
      elem.push(serie);
      elem.push(repet);
      return elem;
    });
    var rutines = [];
    var rutine = [];
    $('#generete-rutine').on('click', function(){
      $( ".exercise-log" ).empty();
      $( ".muscle-log" ).empty();
      $( ".series-log" ).empty();
      $( ".reps-log" ).empty();
      var rutine = []
      $(".exercise-log").append("<h6>EXERCISE</h6>")
      $(".muscle-log").append("<h6>MUSCLE</h6>")
      $(".series-log").append("<h6>SERIES</h6>")
      $(".reps-log").append("<h6>REPS</h6>")
      for(i=0;i<6;i++){
        rutine.push(def[Math.floor(Math.random()*def.length)])
          var exercise = "<h6>"+rutine[i][0]+"</h6>"
          var muscle = "<h6>"+rutine[i][1]+"</h6>"
          var series = "<h6>"+rutine[i][2]+"</h6>"
          var reps = "<h6>"+rutine[i][3]+"</h6>";
          $(".exercise-log").append(exercise)
          $(".muscle-log").append(muscle)
          $(".series-log").append(series)
          $(".reps-log").append(reps)
      }
      console.log(rutine);
